...
import s6 from '../../../../assests/person1.png';

function Section12Skill() {
  return (
    <div className='section1-kalaisurya'>
      <div className='inside-section123'>
        <div className='left-section123'>
          <img src={s6} className="img-fluid" style={{ zIndex: 200000000 }} />
          <div className='empty'>
        ...
        <div className='right-section123'>
          ...
          <div >
            <h4 className='reactjs'>Figma Designs</h4>
          </div>
